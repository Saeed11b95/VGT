    ...
    def tokenize_and_split_bboxs(self, tokens, bboxs):
        ...
        for token, bbox in zip(tokens, bboxs):
            ...
            for split_token in tokens_split_on_whitespace:
                ...
                total_length_all_sub_tokens = sum([len(sub_token) for sub_token in current_sub_tokens])
        ...
        final_outputs = {'input_ids':token_ids, 'bbox_subword_list':split_bboxs, 'texts':tokens, 'bbox_texts_list':bboxs}
