...
class MyDetectionCheckpointer(DetectionCheckpointer):
    def _load_model(self, checkpoint: Any) -> _IncompatibleKeys:
        ...
        """
        DiT_checkpoint_state_dict = torch.load("/home/saeed/Walnut/AdvancedLiterateMachinery/DocumentUnderstanding/VGT/models/dit-base-224-p16-500k-62d53a.zip", map_location=torch.device("cpu"))["model"]
